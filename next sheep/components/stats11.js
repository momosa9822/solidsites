                ...
                {props.stat1Description ?? (
                  <Fragment>
                    <span className="stats11-text21">
                      We have successfully developed over 100 custom websites
                ...
                {props.stat2Description ?? (
                  <Fragment>
                    <span className="stats11-text22">
                      We ensure that 90% of our websites are responsive,
                      providing optimal viewing experience across a wide range
                      of devices.
                    </span>
                  </Fragment>
                )}
                ...
                {props.stat3Description ?? (
                  <Fragment>
                    <span className="stats11-text19">
                      We specialize in SEO optimization, with 80% of our
                      websites ranking higher in search engine results.
                    </span>
                  </Fragment>
                )}
              </span>
