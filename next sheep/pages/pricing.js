    ...
    <>
      <div className="pricing-container">
        ...
        <Features16
          content1={
            <Fragment>
              <span className="pricing-text175">
                ...
                individuals, startups, and small businesses ready to grow
                online. Whether you need a new website or a revamp, we’re here
                to build something that actually works for you.
              </span>
            </Fragment>
          }
          heading1={
          ...
          feature1Title={
            <Fragment>
              <span className="pricing-text177">
          ...
          feature3Description={
            <Fragment>
              <span className="pricing-text182">
                We ensure your website looks great and functions seamlessly on
                all devices.
              </span>
            </Fragment>
          }
        ...
        <FAQ14
          ...
          faq1Question={
            <Fragment>
              <span className="pricing-text194">
